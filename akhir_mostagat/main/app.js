var form = document.getElementById("myForm"),
    ...
    age = document.getElementById("semestre"),
    city = document.getElementById("Module"),
    email = document.getElementById("semaine"),
    phone = document.getElementById("DateDebut"),
    post = document.getElementById("DateFin"),
    sDate = document.getElementById("NumberHeure"),
...
newUserBtn.addEventListener('click', ()=> {
    ...
    modalTitle.innerText = "Formulaire"
    isEdit = false
...
function readInfo(pic, name, age, city, email, phone, post, sDate){
    ...
    document.querySelector("#showsemestre").value = age,
    document.querySelector("#showModule").value = city,
    document.querySelector("#showsemaine").value = email,
    document.querySelector("#showDateDebut").value = phone,
    document.querySelector("#showDateFin").value = post,
    document.querySelector("#showNumberHeure").value = sDate
}
...
form.addEventListener('submit', (e)=> {
    ...
    submitBtn.innerText = "Submit"
    modalTitle.innerHTML = "Formulaire"
